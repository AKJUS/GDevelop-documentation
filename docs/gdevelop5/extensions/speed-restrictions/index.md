...
- **Maximum speed (pixels/second)** (🔢 Number). Default value is `3.554201538002426e-317`.

??? quote "See internal technical details"


    - **Maximum speed (pixels/second)** is stored as `MaximumSpeed` (Number). Default value is `3.554201538002426e-317`.
...
- **Maximum rotation speed (degrees/second)** (🔢 Number). Default value is `3.566782425608127e-317`.

??? quote "See internal technical details"


    - **Maximum rotation speed (degrees/second)** is stored as `MaximumRotationSpeed` (Number). Default value is `3.566782425608127e-317`.
    > This behavior must be used on an object also having a behavior with type "Physics2::Physics2Behavior". This is stored on property `PhysicsBehavior`.
